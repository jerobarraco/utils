...
#Exports
# all these are functions that receive args as params, and must return true/false
# function that tell if it need to run lockal
RUN_LOCAL = None # shouldRunLocal # None
